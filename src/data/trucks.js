...
export const TRUCK_MODELS = [
  {
    id: 'tata-ace-gold', name: 'Tatrax Ace Gold', brand: 'Tatrax',
  ...
  {
    id: 'tata-intra-v30', name: 'Tatrax Intra V30', brand: 'Tatrax',
  ...
  {
    id: 'tata-ultra-t7', name: 'Tatrax Ultra T.7', brand: 'Tatrax',
  ...
  {
    id: 'tata-lpt-1109', name: 'Tatrax LPT 1109', brand: 'Tatrax',
  ...
  {
    id: 'tata-signa-2821', name: 'Tatrax Signa 2821.T', brand: 'Tatrax',
  ...
  {
    id: 'tata-signa-4825', name: 'Tatrax Signa 4825.TK', brand: 'Tatrax',
  ...
  {
    id: 'tata-prima-5530', name: 'Tatrax Prima 5530.S', brand: 'Tatrax',
  ...
  {
    id: 'tata-ace-ev', name: 'Tatrax Ace EV', brand: 'Tatrax',
  ...
  {
    id: 'tata-prima-h55s', name: 'Tatrax Prima H.55S', brand: 'Tatrax',
  ...
  {
    id: 'al-dost-plus', name: 'Veerraj Motors Dost+', brand: 'Veerraj Motors',
  ...
  {
    id: 'al-bada-dost-i4', name: 'Veerraj Motors Bada Dost i4', brand: 'Veerraj Motors',
  ...
  {
    id: 'al-boss-1215', name: 'Veerraj Motors Boss 1215', brand: 'Veerraj Motors',
    tier: 2, propulsion: 'diesel', rating: 4.2, icon: 'truck',
  ...
  {
    id: 'al-ecomet-1615', name: 'Veerraj Motors Ecomet 1615', brand: 'Veerraj Motors',
  ...
  {
    id: 'al-captain-2820', name: 'Veerraj Motors Captain 2820', brand: 'Veerraj Motors',
  ...
  {
    id: 'al-avtr-1922', name: 'Veerraj Motors AVTR 1922', brand: 'Veerraj Motors',
  ...
  {
    id: 'al-avtr-4825', name: 'Veerraj Motors AVTR 4825', brand: 'Veerraj Motors',
    tier: 3, propulsion: 'diesel', rating: 4.6, icon: 'truck-trailer',
  ...
  {
    id: 'al-switch-ev', name: 'Veerraj Motors Switch EV', brand: 'Veerraj Motors',
  ...
  {
    id: 'eicher-pro-2049', name: 'Rathee Pro 2049', brand: 'Rathee Motors',
    tier: 1, propulsion: 'diesel', rating: 4.1, icon: 'truck',
  ...
  {
    id: 'eicher-pro-3015', name: 'Rathee Pro 3015', brand: 'Rathee Motors',
    tier: 2, propulsion: 'diesel', rating: 4.3, icon: 'truck',
  ...
  {
    id: 'eicher-pro-6019', name: 'Rathee Pro 6019', brand: 'Rathee Motors',
    tier: 3, propulsion: 'diesel', rating: 4.5, icon: 'truck-trailer',
  ...
  {
    id: 'eicher-pro-8055-ev', name: 'Rathee Pro 8055 EV', brand: 'Rathee Motors',
  ...
  {
    id: 'mahindra-jeeto', name: 'Mahaveer Jeeto', brand: 'Mahaveer Motors',
  ...
  {
    id: 'mahindra-bolero-maxi', name: 'Mahaveer Bolero Maxi Truck', brand: 'Mahaveer Motors',
    tier: 1, propulsion: 'diesel', rating: 4.0, icon: 'truck-delivery',
  ...
  {
    id: 'mahindra-furio-7', name: 'Mahaveer Furio 7', brand: 'Mahaveer Motors',
    tier: 2, propulsion: 'diesel', rating: 4.3, icon: 'truck',
  ...
  {
    id: 'mahindra-blazo-x28', name: 'Mahaveer Blazo X 28', brand: 'Mahaveer Motors',
    tier: 3, propulsion: 'diesel', rating: 4.5, icon: 'truck-trailer',
  ...
  {
    id: 'mahindra-blazo-x35', name: 'Mahaveer Blazo X 35', brand: 'Mahaveer Motors',
    tier: 3, propulsion: 'diesel', rating: 4.7, icon: 'truck-trailer',
  ...
  {
    id: 'sml-sartaj-gs', name: 'Sanraj Motors Sartaj GS', brand: 'Sanraj Motors',
  ...
  {
    id: 'sml-supreme', name: 'Sanraj Motors Supreme', brand: 'Sanraj Motors',
    tier: 1, propulsion: 'diesel', rating: 4.1, icon: 'truck',
  ...
  {
    id: 'sml-prestige', name: 'Sanraj Motors Prestige', brand: 'Sanraj Motors',
  ...
  {
    id: 'sml-samrat-gs', name: 'Sanraj Motors Samrat GS', brand: 'Sanraj Motors',
  ...
  {
    id: 'force-traveller-van', name: 'Torque Traveller Delivery Van', brand: 'Torque Motors',
  ...
  {
    id: 'force-trump-40', name: 'Torque Trump 40', brand: 'Torque Motors',
  ...
  {
    id: 'volvo-fm-420', name: 'Voltra FM 420', brand: 'Voltra Trucks',
    tier: 3, propulsion: 'diesel', rating: 4.8, icon: 'truck-trailer',
  ...
  {
    id: 'volvo-fh-520', name: 'Voltra FH 520', brand: 'Voltra Trucks',
  ...
  {
    id: 'scania-r-500', name: 'Scanix R 500', brand: 'Scanix',
    tier: 3, propulsion: 'diesel', rating: 5.0, icon: 'truck-trailer',
  ...
  {
    id: 'scania-g-460', name: 'Scanix G 460', brand: 'Scanix',
  ...
  {
    id: 'man-cla-49300', name: 'Vanguard CLA 49.300', brand: 'Vanguard Motors',
    tier: 3, propulsion: 'diesel', rating: 4.7, icon: 'truck-trailer',
  ...
  {
    id: 'man-tgs', name: 'Vanguard TGS', brand: 'Vanguard Motors',
    tier: 3, propulsion: 'diesel', rating: 4.8, icon: 'truck-trailer',
  ...
  {
    id: 'tata-prima-3530k', name: 'Tatrax Prima 3530.K', brand: 'Tatrax',
  ...
  {
    id: 'tata-winger-cargo', name: 'Tatrax Winger Cargo', brand: 'Tatrax',
    tier: 1, propulsion: 'diesel', rating: 3.9, icon: 'van-utility',
  ...
  {
    id: 'al-ecomet-star-1115', name: 'Veerraj Motors Ecomet Star 1115', brand: 'Veerraj Motors',
    tier: 2, propulsion: 'diesel', rating: 4.3, icon: 'truck',
  ...
  {
    id: 'mahindra-furio-14', name: 'Mahaveer Furio 14', brand: 'Mahaveer Motors',
    tier: 2, propulsion: 'diesel', rating: 4.4, icon: 'truck-cargo-container',
  ...
  {
    id: 'volvo-fh16-mega', name: 'Voltra FH16 750 Globetrotter', brand: 'Voltra Trucks',
  ...
  {
    id: 'scania-r770-v8', name: 'Scanix R770 V8', brand: 'Scanix',
    tier: 3, propulsion: 'diesel', rating: 5.0, icon: 'truck-trailer',
  ...
  {
    id: 'benz-actros-2663', name: 'Sterling Actros 2663', brand: 'Sterling Motors',
    tier: 3, propulsion: 'diesel', rating: 4.9, icon: 'truck-trailer',
  ...
  {
    id: 'tata-prima-5540-mega', name: 'Tatrax Prima 5540.S Mega', brand: 'Tatrax',
    tier: 3, propulsion: 'diesel', rating: 4.7, icon: 'truck-trailer',
  ...
  {
    id: 'byd-t9-eplus', name: 'Voltek T9 e-Titan', brand: 'Voltek',
    tier: 3, propulsion: 'electric', rating: 4.8, icon: 'lightning-bolt-circle',
  ...
  {
    id: 'kenworth-w990', name: 'Ironclad W990', brand: 'Ironclad',
  ...
  {
    id: 'freightliner-cascadia', name: 'Longhaul Cascadia', brand: 'Longhaul',
  ...
  {
    id: 'volvo-fh-roadtrain', name: 'Voltra FH B-Double Road Train', brand: 'Voltra Trucks',
  ...
  {
    id: 'man-tgx-roadtrain', name: 'Vanguard TGX B-Double', brand: 'Vanguard Motors',
  ...
  {
    id: 'volvo-fh-electric', name: 'Voltra FH Electric', brand: 'Voltra Trucks',
    tier: 3, propulsion: 'electric', rating: 4.8, icon: 'lightning-bolt-circle',
  ...
  {
    id: 'mercedes-eactros-600', name: 'Sterling eActros 600', brand: 'Sterling Motors',
  ...
  {
    id: 'daf-xg-hybrid', name: 'Roadmax XG Hybrid', brand: 'Roadmax',
  ...
  {
    id: 'tata-ultra-t16', name: 'Tatrax Ultra T.16', brand: 'Tatrax',
  ...
  {
    id: 'eicher-pro-8055', name: 'Rathee Pro 8055', brand: 'Rathee Motors',
  ...
  {
    id: 'scania-r500', name: 'Scanix R500', brand: 'Scanix',
  ...
  {
    id: 'volvo-fh16-roadtrain', name: 'Voltra FH16 Road Train', brand: 'Voltra',
